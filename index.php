...
$alga =800;
$dovanos = rand (1,100);
for ($menesis =1; $menesis<12; $menesis++){
    $dovanos = rand (1,100);
$manopinigai +=$alga -$islaidos - $dovanos;
print $menesis . 'menuo__' . 'mano pinigai eur='.$manopinigai . '__##'. $dovanos. '__##';}
?>
<html>
    <title>
